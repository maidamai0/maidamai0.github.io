...
QT_MOC_LITERAL(1, 10, 13), // "onNameChanged"
QT_MOC_LITERAL(2, 24, 4) // "name"

    },
    "UserModel\0onNameChanged\0name"
};
...
Q_DECL_UNUSED static void checkNotifySignalValidity_UserModel(UserModel *t) {
    t->onNameChanged();
}
QT_WARNING_POP

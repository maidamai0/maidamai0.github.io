...
void QReport::MakePDFReport(QString&& dir) {
  QString full_file_path = dir + QDir::separator() + "report.pdf";
  ...
  const auto image_path = dir + QDir::separator() + "smile.png";
  QPixmap titleImage;
  titleImage.load(image_path);
